...
(function (root, factory) {
  ...
  */
  ...
  introJs.fn = IntroJs.prototype = {
    ...
    start: function (path) {
    	if(path !== '/') {
    		var menuElement = document.getElementsByClassName('menu-page');
    		var introElements = menuElement[0].querySelectorAll('[data-step]');
    		introElements.forEach(function(item) {
    			item.removeAttribute('data-step');
    			item.removeAttribute('data-intro');
    		});
    	}
